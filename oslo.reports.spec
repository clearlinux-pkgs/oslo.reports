...
Source0  : http://tarballs.openstack.org/oslo.reports/oslo.reports-2.0.1.tar.gz
Source1  : http://tarballs.openstack.org/oslo.reports/oslo.reports-2.0.1.tar.gz.asc
...
%prep
%setup -q -n oslo.reports-2.0.1
cd %{_builddir}/oslo.reports-2.0.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1586273328
...
cp %{_builddir}/oslo.reports-2.0.1/LICENSE %{buildroot}/usr/share/package-licenses/oslo.reports/294b43b2cec9919063be1a3b49e8722648424779
