...
Version  : 1.5.0
Release  : 10
URL      : http://tarballs.openstack.org/oslo.reports/oslo.reports-1.5.0.tar.gz
Source0  : http://tarballs.openstack.org/oslo.reports/oslo.reports-1.5.0.tar.gz
