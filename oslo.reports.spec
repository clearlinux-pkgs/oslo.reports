...
Version  : 1.3.0
Release  : 7
URL      : http://tarballs.openstack.org/oslo.reports/oslo.reports-1.3.0.tar.gz
Source0  : http://tarballs.openstack.org/oslo.reports/oslo.reports-1.3.0.tar.gz
